  ...
  return (
    <div> 
      <div className="flex flex-col md:flex-row items-center justify-center mt-8 pl-8 pr-8">
        ...
        <div className="w-full md:w-1/2 p-5 mx-4 flex flex-col items-end">
          {/* Cambiar por otra imagen, que venga desde la db */}
          <img src="https://www.koaj.co/themes/koaj/img/register-May-2024.jpeg" alt="Register Illustration" className="w-full rounded-lg shadow-md mb-4" />
          <button
            onClick={handleBack}
