      ...
      <div className="bg-white">
        ...
        <header className="relative bg-white">
          <p className="flex h-10 items-center justify-center bg-black px-4 text-sm sm:text-base md:text-lg font-medium text-white sm:px-6 lg:px-8">
            <TruckIcon className="h-6 w-6 mr-2" /> Shop now and enjoy free
            shipping on all your orders!
          </p>
          ...
          >
            <div className="border-b border-gray-200">
              <div className="flex h-16 items-center">
                ...
                {/* Flyout menus */}
                <PopoverGroup
                  className="navigation hidden lg:ml-8 lg:block lg:self-stretch"
                  style={{ zIndex: 1000 }}
                >
                ...
                <div className="ml-auto flex items-center">
                  <div className="flex flex-1 items-center justify-end space-x-6">
                    <NavLink
                      to="/login"
                      className="text-gray-400 hover:text-gray-500 p-2 sm:p-0"
                    >
